...
#ifdef BLUETOOTH_RTK
#ifdef BLUETOOTH_RTK4_2
/* the event mask for BLE event mask */
#define HCI_BLE_EVENT_MASK_DEF               "\x00\x00\x00\x00\x00\x00\x0D\x7f"
#else
/* the event mask for BLE event mask */
...
#ifdef BLUETOOTH_RTK_4_2
//supported cmd
#define HCI_LE_SET_DATA_LEN_SUPPORTED(x) ((x)[33] & 0x40)
...
#define HCI_LE_EXT_CREATE_CONNECTION_SUPPORTED(x) ((x)[37] & 0x80)
