...
HCI_API extern BOOLEAN btsnd_hcic_read_encr_key_size (UINT16 handle, void *p_cmd_cplt_cback);
#endif
...
#define HCIC_PARAM_SIZE_BLE_CREATE_EXT_LL_CONN  62
#define HCIC_PARAM_SIZE_BLE_SET_DEFAULT_PHY     3
#define HCIC_PARAM_SIZE_BLE_PHY                 7
...
HCI_API extern BOOLEAN btsnd_hcic_ble_set_phy(UINT16 handle, UINT8 all_phys,
                                     UINT8 tx_phys, UINT8 rx_phys, UINT16 phy_opt);

HCI_API extern BOOLEAN btsnd_hcic_ble_ext_create_conn(UINT8 init_filter_policy,
                                           UINT8 addr_type_own,
                                           UINT8 addr_type_peer,
                                           BD_ADDR bda_peer,
                                           UINT8 initiating_phys,
                                           struct EXT_CONN_PHY_CFG* phy_cfg);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_data_length(UINT16 conn_handle, UINT16 tx_octets,
                                    UINT16 tx_time);

HCI_API extern BOOLEAN btsnd_hcic_ble_read_suggested_default_data_length(void);
HCI_API extern BOOLEAN btsnd_hcic_ble_read_maximum_data_length(void);
#endif
