...
#define BTM_BLE_SCAN_SLOW_INT_1    144    /* 1.28 s   = 2048 *0.625 */
#endif
#ifndef BTM_BLE_SCAN_SLOW_WIN_1
#define BTM_BLE_SCAN_SLOW_WIN_1   16      /* 11.25 ms = 18 *0.625 */
#endif
 ...
 *
 ******************************************************************************/
BTM_API extern BOOLEAN BTM_IsBleConnection(UINT16 conn_handle);
#endif
 ...
 *
 ******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetBleDataLength(BD_ADDR bd_addr, UINT16 tx_pdu_length);
#endif
