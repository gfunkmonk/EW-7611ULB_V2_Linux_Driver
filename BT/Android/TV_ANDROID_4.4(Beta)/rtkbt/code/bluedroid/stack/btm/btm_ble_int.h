...
#define BTM_BLE_GAP_DISC_SCAN_INT   (0x70)         /* Interval(scan_int) = 11.25 ms= 0x0010 * 0.625 ms */
#define BTM_BLE_GAP_DISC_SCAN_WIN   (0x10)         /* scan_window = 11.25 ms= 0x0010 * 0.625 ms */
...
typedef struct
{
    ...
    *****************************************************/
    ...
    UINT16 suggested_default_data_length;
    UINT16 supported_max_tx_octets;
    UINT16 supported_max_tx_time;
    UINT16 supported_max_rx_octets;
    UINT16 supported_max_rx_time;
#endif
} tBTM_BLE_CB;
...
#ifdef BLUETOOTH_RTK_4_2
extern void btm_ble_process_phy_update_pkt(UINT8 len, UINT8* p);
#endif
...
#ifdef BLUETOOTH_RTK_4_2
extern void btm_ble_enchance_conn_complete(UINT8 *p, UINT16 evt_len);
#endif
