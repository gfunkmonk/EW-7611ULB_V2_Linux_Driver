...
void BTM_SetDefaultPHYLinkPolicy () {
    UINT8 all_phy, tx_phy, rx_phy;
    if(HCI_LE_SET_DEFAULT_PHY_SUPPORTED(btm_cb.devcb.supported_cmds)) {
        all_phy = 0;
        ...
        btsnd_hcic_ble_set_default_phy(all_phy, tx_phy, rx_phy);
    }
}
#endif
