...
extern void btm_ble_read_default_data_length_complete (UINT8 *p, UINT16 evt_len);
extern void btm_ble_read_maximum_data_length_complete (UINT8 *p, UINT16 evt_len);
extern UINT16 btm_ble_suggested_default_data_length (void);
#endif
#endif  /* BLE_INCLUDED */
