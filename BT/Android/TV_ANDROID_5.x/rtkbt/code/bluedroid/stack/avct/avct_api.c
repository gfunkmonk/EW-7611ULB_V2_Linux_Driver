...
void AVCT_Register(UINT16 mtu, UINT16 mtu_br, UINT8 sec_mask)
{
    UNUSED(mtu_br);
#ifdef BLUETOOTH_RTK
    UINT8 trace_level_temp = avct_cb.trace_level;
#endif
...
#ifdef BLUETOOTH_RTK
    avct_cb.trace_level = trace_level_temp;
    if(avct_cb.trace_level < AVCT_INITIAL_TRACE_LEVEL)
#endif
...
UINT8 AVCT_SetTraceLevel (UINT8 new_level)
{
    ...
    AVCT_TRACE_WARNING("avct_cb.trace_level = %d", avct_cb.trace_level);
