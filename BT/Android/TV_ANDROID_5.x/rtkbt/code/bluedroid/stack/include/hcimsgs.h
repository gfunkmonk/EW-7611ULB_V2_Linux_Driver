...
HCI_API extern BOOLEAN btsnd_hcic_write_sync_train_param (UINT8* p_data);
#define HCIC_PARAM_SIZE_WRITE_SYNC_TRAIN_PARAM      9

HCI_API extern BOOLEAN btsnd_hcic_write_clb_data (UINT8* p_data, UINT8 len);
#define HCIC_PARAM_SIZE_SET_CLB_DATA_EXCPT      3

HCI_API extern BOOLEAN btsnd_hcic_set_clb (UINT8* p_data);
