...
#define BTM_AUTH_SPGBSC_YES 13  /* MITM Protection Required - Single Profiles/general bonding/Secure connection
                                Use IO Capabilities to determine authentication procedure */
#endif
...
#ifdef BLUETOOTH_RTK_SC
    ,BTM_LE_KEY_CFM_EVT     /* passkey confirm event*/
#endif
};
...
#ifdef BLUETOOTH_RTK_SC
#define BTM_LE_AUTH_REQ_SC      SMP_AUTH_SC_BIT    /* 1 << 3 */
#endif
typedef UINT8 tBTM_LE_AUTH_REQ;

#ifdef BLUETOOTH_RTK_SC
#define BTM_LE_AUTH_REQ_MASK SMP_AUTH_SC_MASK  /* 0x13*/
#else
