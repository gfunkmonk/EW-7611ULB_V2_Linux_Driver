                                            ...
                                            UINT16 latency, UINT16 timeout)
{
    ...
    L2CAP_TRACE_API ("%s - BD_ADDR %08x%04x current upd state 0x%02x",__FUNCTION__,
            (rem_bda[0]<<24)+(rem_bda[1]<<16)+(rem_bda[2]<<8)+rem_bda[3],
            (rem_bda[4]<<8)+rem_bda[5], p_lcb->conn_update_mask);
...
void l2cble_notify_le_connection (BD_ADDR bda)
{
    ...
    L2CAP_TRACE_DEBUG ("l2cble_notify_le_connection ");
