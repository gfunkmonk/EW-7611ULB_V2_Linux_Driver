...
#ifdef BLUETOOTH_RTK_SC
#define SMP_OPCODE_PAIRING_PUB_KEY        0x0C
#define SMP_OPCODE_PAIRING_DHK_CHECK      0x0D
#define SMP_OPCODE_PAIRING_KPR_NOTIF      0x0E
#define SMP_OPCODE_MAX                    (SMP_OPCODE_PAIRING_KPR_NOTIF + 1)
#else
...
#ifdef BLUETOOTH_RTK_SC
#define SMP_PAIRING_PUB_KEY_EVT         SMP_OPCODE_PAIRING_PUB_KEY
#define SMP_PAIRING_DHK_CHECK_EVT       SMP_OPCODE_PAIRING_DHK_CHECK
#define SMP_PAIRING_KPR_NOTIF_EVT       SMP_OPCODE_PAIRING_KPR_NOTIF
#define SMP_SELF_DEF_EVT                SMP_PAIRING_KPR_NOTIF_EVT
#else
...
#ifdef BLUETOOTH_RTK_SC
#define SMP_PK_READY_EVT                (SMP_SELF_DEF_EVT + 14)
#define SMP_USER_CONFIRM_EVT            (SMP_SELF_DEF_EVT + 15)
#define SMP_DHK_CHECK_EVT               (SMP_SELF_DEF_EVT + 16)
#define SMP_PASSKEY_CFM_EVT             (SMP_SELF_DEF_EVT + 17)
#define SMP_MAX_EVT         SMP_PASSKEY_CFM_EVT + 1
#else
...
#ifdef BLUETOOTH_RTK_SC
#define SMP_SC_REQUIRED(x)  (((x) & SMP_AUTH_SC_BIT) == (0x08))
#endif
...
typedef struct
{
    ...
    BT_OCTET32      dhkey;
    BT_OCTET16      mackey;
    BT_OCTET16      dhk_check;
    BT_OCTET16      rdhk_check;
    BOOLEAN         sec_con;
    tSMP_ASSO_MODEL model;
    UINT8           sc_state;
    UINT8           cfm_proc_times;
#endif
...
#ifdef BLUETOOTH_RTK_SC
extern BOOLEAN smp_generate_pulic_key(BT_OCTET64 local_pk, BT_OCTET64 local_sk);
extern void smp_sc_calculate_dhkey(tSMP_CB *p_cb, BT_OCTET32 dhkey);
extern void smp_exchange_pubkey(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern void smp_proc_pk_rsp(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern void smp_generate_dhkey(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern void smp_check_rand(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern void smp_num_comp_calc(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern void smp_generate_num_comp(tSMP_CB *p_cb, UINT32 *value);
extern void smp_send_dhk_check(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern void smp_proc_dhk_check(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern void smp_comp_dhk_check(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern BOOLEAN smp_generate_dhkey_check(tSMP_CB *p_cb, UINT8 role,BT_OCTET16 rdhk_check_calc);
extern void smp_generate_rand(tSMP_CB *p_cb, tSMP_INT_DATA *p_data);
extern void smp_generate_test(void);
#endif
