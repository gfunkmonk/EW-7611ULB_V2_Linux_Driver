...
#define BTA_DM_BLE_CFM_REQ_EVT          27      /* SMP passkey confirm event*/
#endif
...
BTA_API extern void BTA_DmAddUnpairCollisionList(BD_ADDR bd_addr, BOOLEAN add);
BTA_API extern BOOLEAN BTA_DmCheckUnpairCollisionList(BD_ADDR bd_addr);
#endif
