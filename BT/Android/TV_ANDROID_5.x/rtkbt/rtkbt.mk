# RELEASE NAME: 20210702_TV_ANDROID_5.x
# RTKBT_API_VERSION=1.1.3.0

BOARD_HAVE_BLUETOOTH := true
BOARD_HAVE_BLUETOOTH_RTK := true
BOARD_HAVE_BLUETOOTH_RTK_COEX := true
BOARD_HAVE_BLUETOOTH_RTK_HEARTBEAT := true
...
PRODUCT_PROPERTY_OVERRIDES += persist.bluetooth.prefferedrole=master
