...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE(USB_VENDER_ID_EDIMAX, 0xA822), .driver_info = RTL8812}, /* Edimax - Edimax */
	...
	/*=== Customer ID ===*/
	{USB_DEVICE(USB_VENDER_ID_EDIMAX, 0xA811), .driver_info = RTL8821}, /* Edimax - Edimax */
	...
	{USB_DEVICE(USB_VENDER_ID_EDIMAX, 0xA834), .driver_info = RTL8814A}, /* Edimax - Edimax */
	...
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_EDIMAX, 0xd611, 0xff, 0xff, 0xff), .driver_info = RTL8723D}, /* 8723DU 1*2 */
#endif
